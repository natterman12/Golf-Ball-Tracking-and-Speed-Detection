...
hsvVals = {'hmin': 0, 'smin': 188, 'vmin': 0, 'hmax': 15, 'smax': 255, 'vmax': 255}

if args.get("ballcolor", False):
    match args["ballcolor"]:
        case "white":
            hsvVals = {'hmin': 127, 'smin': 192, 'vmin': 182, 'hmax': 179, 'smax': 255, 'vmax': 255}
        case "yellow":
            hsvVals = {'hmin': 0, 'smin': 188, 'vmin': 0, 'hmax': 15, 'smax': 255, 'vmax': 255} # 
        case "orange":
            hsvVals = {'hmin': 3, 'smin': 157, 'vmin': 56, 'hmax': 40, 'smax': 255, 'vmax': 255} # sim room
        case "lightorange":
            hsvVals = {'hmin': 3, 'smin': 181, 'vmin': 134, 'hmax': 40, 'smax': 255, 'vmax': 255}# light
        case "green":
            hsvVals = {'hmin': 0, 'smin': 150, 'vmin': 166, 'hmax': 22, 'smax': 255, 'vmax': 255}              
        case "red":
            hsvVals = {'hmin': 0, 'smin': 13, 'vmin': 207, 'hmax': 92, 'smax': 115, 'vmax': 255}#
        case _:
            hsvVals = {'hmin': 0, 'smin': 188, 'vmin': 0, 'hmax': 15, 'smax': 255, 'vmax': 255}
